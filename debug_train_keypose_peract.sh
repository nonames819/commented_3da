...
main_dir=/data/chd_data/ckpt/3d_actor/debug/Actor_18Peract_100Demo_multitask
...
interpolation_length=2 # keypose so 2
num_history=3
...
CUDA_VISIBLE_DEVICES=7 CUDA_LAUNCH_BLOCKING=1 torchrun --nproc_per_node $ngpus --master_port $RANDOM \
    -m debugpy --listen 5678 --wait-for-client main_trajectory.py \
