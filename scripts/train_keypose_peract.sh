...
main_dir=/data/chd_data/ckpt/3d_actor/Actor_18Peract_100Demo_multitask
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 CUDA_LAUNCH_BLOCKING=1 torchrun --nproc_per_node $ngpus --master_port $RANDOM \
    main_trajectory.py \
